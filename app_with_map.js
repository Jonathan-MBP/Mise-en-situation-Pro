...
const TRANSLATIONS = {
    ...
    ru: {
        ...
        "kpi-fin-margin": "Чистая прибыль",
        "trend-this-month-1": "В этом месяце",
        "trend-target-98": "Цель: 98%",
        ...
        allData.map.forEach(building => {
            ...
            marker.bindPopup(`
                <div class="building-popup">
                    ...
                    <br>
                    ${labelOcc}: <span class="numeric-value">${building.occupancy_rate.toFixed(1)}% (${building.occupied_units}/${building.total_units})</span><br>
                    ${labelRent}: <span class="numeric-value">${formatCurrency(building.monthly_rent)}</span>
                </div>
            `);
